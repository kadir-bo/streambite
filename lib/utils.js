export function formatTime(timestamp) {
  ...
  return isToday
    ? `heute um ${time}Uhr`
    : `${date.toLocaleDateString("de-DE", { day: "2-digit", month: "2-digit", year: "numeric" })} ${time}Uhr`;
}
 ...
 * Leise – kein Feedback-State, nur die Write-Operation.
 */
...
/**
 * Berechnet die Position eines Dropdown-Menüs relativ zu einem Anker-Element.
 * Platziert das Menü rechtsbündig unter dem Anker.
 */
export function getMenuPosFromAnchor(el, menuWidth = 220) {
