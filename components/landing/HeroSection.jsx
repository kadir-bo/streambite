  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 size-175 bg-(--accent) opacity-[0.05] rounded-full blur-3xl" />
        <div className="absolute bottom-1/3 right-1/4 size-125 bg-(--accent) opacity-[0.03] rounded-full blur-3xl" />
        <div className="absolute top-1/3 left-1/6 size-75 bg-(--accent) opacity-[0.02] rounded-full blur-3xl" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        <h1 className="text-4xl sm:text-6xl md:text-7xl font-bold tracking-tight leading-[1.05] mb-4 sm:mb-6">
          Deine Community.
          <br />
          <span className="text-transparent bg-clip-text bg-linear-to-r from-(--accent) to-indigo-400">
