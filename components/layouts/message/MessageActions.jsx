...
export default function MessageActions({
  ...
  return (
    <motion.div
      ...
      animate="visible"
      exit="exit"
      className="inline-flex items-center gap-0.5 bg-zinc-800 border border-white/10 rounded-lg px-1 py-0.5 shadow-md"
    >
      {/* Emoji */}
        ...
        <AnimatePresence>
          {moreOpen && (
            <motion.div
              ...
              className="absolute top-[calc(100%+4px)] right-0 min-w-40 bg-zinc-800 border border-white/10 rounded-lg shadow-md z-[100] overflow-hidden p-1"
            >
              <DropdownItem
                icon={Copy}
