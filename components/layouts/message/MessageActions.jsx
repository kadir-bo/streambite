...
export default function MessageActions({
  ...
  return (
    <motion.div
      ...
      animate="visible"
      exit="exit"
      className="inline-flex items-center gap-0.5 bg-zinc-800 border border-white/10 rounded-lg px-1 py-0.5 shadow-[0_8px_24px_rgba(0,0,0,0.5)]"
    >
      {/* Emoji */}
        ...
        <AnimatePresence>
          {moreOpen && (
            <motion.div
              ...
              className="absolute top-[calc(100%+4px)] right-0 min-w-40 bg-zinc-800 border border-white/10 rounded-lg shadow-[0_8px_24px_rgba(0,0,0,0.5)] z-[100] overflow-hidden p-1"
            >
              <DropdownItem
                icon={Copy}
