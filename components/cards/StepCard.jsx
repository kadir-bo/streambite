    ...
    >
      ...
      <div className="relative mb-5">
        ...
        <motion.div
          ...
          className="absolute -top-1.5 -right-1.5 size-6 rounded-full bg-(--accent) text-white text-xs font-bold flex items-center justify-center shadow-xl shadow-(--accent)/30"
        >
          {step.number}
        </motion.div>
      </div>
